...
go run go/tools/asthelpergen -in ./go/tools/asthelpergen/integration -iface github.com/xawk/vitess/go/tools/asthelpergen/integration.AST -except "*NoCloneType"
*/
