...
func (cached *AddColumns) CachedSize(alloc bool) int64 {
	...
	// field Columns []*github.com/xawk/vitess/go/vt/sqlparser.ColumnDefinition
	{
	...
	// field First *github.com/xawk/vitess/go/vt/sqlparser.ColName
	size += cached.First.CachedSize(true)
	// field After *github.com/xawk/vitess/go/vt/sqlparser.ColName
...
func (cached *AddConstraintDefinition) CachedSize(alloc bool) int64 {
	...
	// field ConstraintDefinition *github.com/xawk/vitess/go/vt/sqlparser.ConstraintDefinition
...
func (cached *AddIndexDefinition) CachedSize(alloc bool) int64 {
	...
	// field IndexDefinition *github.com/xawk/vitess/go/vt/sqlparser.IndexDefinition
...
func (cached *AliasedExpr) CachedSize(alloc bool) int64 {
	...
	// field Expr github.com/xawk/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Expr.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field As github.com/xawk/vitess/go/vt/sqlparser.ColIdent
...
func (cached *AliasedTableExpr) CachedSize(alloc bool) int64 {
	...
	// field Expr github.com/xawk/vitess/go/vt/sqlparser.SimpleTableExpr
	if cc, ok := cached.Expr.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Partitions github.com/xawk/vitess/go/vt/sqlparser.Partitions
	{
	...
	// field As github.com/xawk/vitess/go/vt/sqlparser.TableIdent
	size += cached.As.CachedSize(false)
	// field Hints *github.com/xawk/vitess/go/vt/sqlparser.IndexHints
...
func (cached *AlterColumn) CachedSize(alloc bool) int64 {
	...
	// field Column *github.com/xawk/vitess/go/vt/sqlparser.ColName
	size += cached.Column.CachedSize(true)
	// field DefaultVal github.com/xawk/vitess/go/vt/sqlparser.Expr
...
func (cached *AlterTable) CachedSize(alloc bool) int64 {
	...
	// field Table github.com/xawk/vitess/go/vt/sqlparser.TableName
	size += cached.Table.CachedSize(false)
	// field AlterOptions []github.com/xawk/vitess/go/vt/sqlparser.AlterOption
	{
	...
	// field PartitionSpec *github.com/xawk/vitess/go/vt/sqlparser.PartitionSpec
...
func (cached *AlterView) CachedSize(alloc bool) int64 {
	...
	// field ViewName github.com/xawk/vitess/go/vt/sqlparser.TableName
	...
	// field Columns github.com/xawk/vitess/go/vt/sqlparser.Columns
	{
	...
	// field Select github.com/xawk/vitess/go/vt/sqlparser.SelectStatement
...
func (cached *AlterVschema) CachedSize(alloc bool) int64 {
	...
	// field Table github.com/xawk/vitess/go/vt/sqlparser.TableName
	size += cached.Table.CachedSize(false)
	// field VindexSpec *github.com/xawk/vitess/go/vt/sqlparser.VindexSpec
	size += cached.VindexSpec.CachedSize(true)
	// field VindexCols []github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	{
	...
	// field AutoIncSpec *github.com/xawk/vitess/go/vt/sqlparser.AutoIncSpec
...
func (cached *AndExpr) CachedSize(alloc bool) int64 {
	...
	// field Left github.com/xawk/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Left.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Right github.com/xawk/vitess/go/vt/sqlparser.Expr
...
func (cached *AutoIncSpec) CachedSize(alloc bool) int64 {
	...
	// field Column github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	size += cached.Column.CachedSize(false)
	// field Sequence github.com/xawk/vitess/go/vt/sqlparser.TableName
...
func (cached *CaseExpr) CachedSize(alloc bool) int64 {
	...
	// field Whens []*github.com/xawk/vitess/go/vt/sqlparser.When
	{
	...
	// field Else github.com/xawk/vitess/go/vt/sqlparser.Expr
...
func (cached *ChangeColumn) CachedSize(alloc bool) int64 {
	...
	// field OldColumn *github.com/xawk/vitess/go/vt/sqlparser.ColName
	size += cached.OldColumn.CachedSize(true)
	// field NewColDefinition *github.com/xawk/vitess/go/vt/sqlparser.ColumnDefinition
...
func (cached *ColName) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	size += cached.Name.CachedSize(false)
	// field Qualifier github.com/xawk/vitess/go/vt/sqlparser.TableName
...
func (cached *ColumnDefinition) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	size += cached.Name.CachedSize(false)
	// field Type github.com/xawk/vitess/go/vt/sqlparser.ColumnType
...
func (cached *ColumnType) CachedSize(alloc bool) int64 {
	...
	// field Options *github.com/xawk/vitess/go/vt/sqlparser.ColumnTypeOptions
	size += cached.Options.CachedSize(true)
	// field Length *github.com/xawk/vitess/go/vt/sqlparser.Literal
	size += cached.Length.CachedSize(true)
	// field Scale *github.com/xawk/vitess/go/vt/sqlparser.Literal
...
func (cached *ColumnTypeOptions) CachedSize(alloc bool) int64 {
	...
	// field Default github.com/xawk/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Default.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field OnUpdate github.com/xawk/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.OnUpdate.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Comment *github.com/xawk/vitess/go/vt/sqlparser.Literal
...
func (cached *ComparisonExpr) CachedSize(alloc bool) int64 {
	...
	// field Escape github.com/xawk/vitess/go/vt/sqlparser.Expr
...
func (cached *ConstraintDefinition) CachedSize(alloc bool) int64 {
	...
	// field Details github.com/xawk/vitess/go/vt/sqlparser.ConstraintInfo
...
func (cached *ConvertExpr) CachedSize(alloc bool) int64 {
	...
	// field Type *github.com/xawk/vitess/go/vt/sqlparser.ConvertType
...
func (cached *CreateTable) CachedSize(alloc bool) int64 {
	...
	// field Table github.com/xawk/vitess/go/vt/sqlparser.TableName
	size += cached.Table.CachedSize(false)
	// field TableSpec *github.com/xawk/vitess/go/vt/sqlparser.TableSpec
	size += cached.TableSpec.CachedSize(true)
	// field OptLike *github.com/xawk/vitess/go/vt/sqlparser.OptLike
...
func (cached *CurTimeFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	size += cached.Name.CachedSize(false)
	// field Fsp github.com/xawk/vitess/go/vt/sqlparser.Expr
...
func (cached *DropColumn) CachedSize(alloc bool) int64 {
	...
	// field Name *github.com/xawk/vitess/go/vt/sqlparser.ColName
...
func (cached *DropTable) CachedSize(alloc bool) int64 {
	...
	// field FromTables github.com/xawk/vitess/go/vt/sqlparser.TableNames
	{
...
func (cached *ExistsExpr) CachedSize(alloc bool) int64 {
	...
	// field Subquery *github.com/xawk/vitess/go/vt/sqlparser.Subquery
...
func (cached *ForeignKeyDefinition) CachedSize(alloc bool) int64 {
	...
	// field Source github.com/xawk/vitess/go/vt/sqlparser.Columns
	{
	...
	// field ReferencedTable github.com/xawk/vitess/go/vt/sqlparser.TableName
	size += cached.ReferencedTable.CachedSize(false)
	// field ReferencedColumns github.com/xawk/vitess/go/vt/sqlparser.Columns
	{
...
func (cached *FuncExpr) CachedSize(alloc bool) int64 {
	...
	// field Qualifier github.com/xawk/vitess/go/vt/sqlparser.TableIdent
	size += cached.Qualifier.CachedSize(false)
	// field Name github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	size += cached.Name.CachedSize(false)
	// field Exprs github.com/xawk/vitess/go/vt/sqlparser.SelectExprs
	{
...
func (cached *GroupConcatExpr) CachedSize(alloc bool) int64 {
	...
	// field OrderBy github.com/xawk/vitess/go/vt/sqlparser.OrderBy
	{
	...
	// field Limit *github.com/xawk/vitess/go/vt/sqlparser.Limit
...
func (cached *IndexDefinition) CachedSize(alloc bool) int64 {
	...
	// field Info *github.com/xawk/vitess/go/vt/sqlparser.IndexInfo
	size += cached.Info.CachedSize(true)
	// field Columns []*github.com/xawk/vitess/go/vt/sqlparser.IndexColumn
	{
		size += int64(cap(cached.Columns)) * int64(8)
		for _, elem := range cached.Columns {
			size += elem.CachedSize(true)
	...
	// field Options []*github.com/xawk/vitess/go/vt/sqlparser.IndexOption
	{
...
func (cached *IndexHints) CachedSize(alloc bool) int64 {
	...
	// field Indexes []github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	{
...
func (cached *IndexInfo) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	size += cached.Name.CachedSize(false)
	// field ConstraintName github.com/xawk/vitess/go/vt/sqlparser.ColIdent
...
func (cached *IndexOption) CachedSize(alloc bool) int64 {
	...
	// field Name string
	size += int64(len(cached.Name))
	// field Value *github.com/xawk/vitess/go/vt/sqlparser.Literal
...
func (cached *JoinCondition) CachedSize(alloc bool) int64 {
	...
	// field On github.com/xawk/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.On.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Using github.com/xawk/vitess/go/vt/sqlparser.Columns
	{
...
func (cached *JoinTableExpr) CachedSize(alloc bool) int64 {
	...
	// field LeftExpr github.com/xawk/vitess/go/vt/sqlparser.TableExpr
	if cc, ok := cached.LeftExpr.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field RightExpr github.com/xawk/vitess/go/vt/sqlparser.TableExpr
	if cc, ok := cached.RightExpr.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Condition github.com/xawk/vitess/go/vt/sqlparser.JoinCondition
...
func (cached *Limit) CachedSize(alloc bool) int64 {
	...
	// field Offset github.com/xawk/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Offset.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Rowcount github.com/xawk/vitess/go/vt/sqlparser.Expr
...
func (cached *MatchExpr) CachedSize(alloc bool) int64 {
	...
	// field Columns github.com/xawk/vitess/go/vt/sqlparser.SelectExprs
	{
...
func (cached *OptLike) CachedSize(alloc bool) int64 {
	...
	// field LikeTable github.com/xawk/vitess/go/vt/sqlparser.TableName
...
func (cached *OrderByOption) CachedSize(alloc bool) int64 {
	...
	// field Cols github.com/xawk/vitess/go/vt/sqlparser.Columns
	{
...
func (cached *ParenTableExpr) CachedSize(alloc bool) int64 {
	...
	// field Exprs github.com/xawk/vitess/go/vt/sqlparser.TableExprs
	{
		size += int64(cap(cached.Exprs)) * int64(16)
		for _, elem := range cached.Exprs {
			if cc, ok := elem.(cachedObject); ok {
...
func (cached *ParsedQuery) CachedSize(alloc bool) int64 {
	...
	// field bindLocations []github.com/xawk/vitess/go/vt/sqlparser.bindLocation
	{
...
func (cached *PartitionDefinition) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	size += cached.Name.CachedSize(false)
	// field Limit github.com/xawk/vitess/go/vt/sqlparser.Expr
...
func (cached *PartitionSpec) CachedSize(alloc bool) int64 {
	...
	// field Names github.com/xawk/vitess/go/vt/sqlparser.Partitions
	{
	...
	// field Number *github.com/xawk/vitess/go/vt/sqlparser.Literal
	size += cached.Number.CachedSize(true)
	// field TableName github.com/xawk/vitess/go/vt/sqlparser.TableName
	size += cached.TableName.CachedSize(false)
	// field Definitions []*github.com/xawk/vitess/go/vt/sqlparser.PartitionDefinition
	{
...
func (cached *RangeCond) CachedSize(alloc bool) int64 {
	...
	// field From github.com/xawk/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.From.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field To github.com/xawk/vitess/go/vt/sqlparser.Expr
...
func (cached *RenameTable) CachedSize(alloc bool) int64 {
	...
	// field TablePairs []*github.com/xawk/vitess/go/vt/sqlparser.RenameTablePair
	{
...
func (cached *RenameTablePair) CachedSize(alloc bool) int64 {
	...
	// field FromTable github.com/xawk/vitess/go/vt/sqlparser.TableName
	size += cached.FromTable.CachedSize(false)
	// field ToTable github.com/xawk/vitess/go/vt/sqlparser.TableName
...
func (cached *Select) CachedSize(alloc bool) int64 {
	...
	// field Cache *bool
	size += int64(1)
	// field Comments github.com/xawk/vitess/go/vt/sqlparser.Comments
	{
	...
	// field SelectExprs github.com/xawk/vitess/go/vt/sqlparser.SelectExprs
	{
	...
	// field From github.com/xawk/vitess/go/vt/sqlparser.TableExprs
	{
	...
	// field Where *github.com/xawk/vitess/go/vt/sqlparser.Where
	size += cached.Where.CachedSize(true)
	// field GroupBy github.com/xawk/vitess/go/vt/sqlparser.GroupBy
	{
	...
	// field Having *github.com/xawk/vitess/go/vt/sqlparser.Where
	...
	// field Limit *github.com/xawk/vitess/go/vt/sqlparser.Limit
	size += cached.Limit.CachedSize(true)
	// field Into *github.com/xawk/vitess/go/vt/sqlparser.SelectInto
...
func (cached *SubstrExpr) CachedSize(alloc bool) int64 {
	...
	// field Name *github.com/xawk/vitess/go/vt/sqlparser.ColName
	size += cached.Name.CachedSize(true)
	// field StrVal *github.com/xawk/vitess/go/vt/sqlparser.Literal
...
func (cached *TableName) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/xawk/vitess/go/vt/sqlparser.TableIdent
	size += cached.Name.CachedSize(false)
	// field Qualifier github.com/xawk/vitess/go/vt/sqlparser.TableIdent
	size += cached.Qualifier.CachedSize(false)
	return size
...
func (cached *TableOption) CachedSize(alloc bool) int64 {
	...
	// field String string
	size += int64(len(cached.String))
	// field Tables github.com/xawk/vitess/go/vt/sqlparser.TableNames
	{
...
func (cached *TableSpec) CachedSize(alloc bool) int64 {
	...
	// field Indexes []*github.com/xawk/vitess/go/vt/sqlparser.IndexDefinition
	{
	...
	// field Constraints []*github.com/xawk/vitess/go/vt/sqlparser.ConstraintDefinition
	{
	...
	// field Options github.com/xawk/vitess/go/vt/sqlparser.TableOptions
	{
		size += int64(cap(cached.Options)) * int64(8)
		for _, elem := range cached.Options {
			size += elem.CachedSize(true)
...
func (cached *TimestampFuncExpr) CachedSize(alloc bool) int64 {
	...
	// field Name string
	size += int64(len(cached.Name))
	// field Expr1 github.com/xawk/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Expr1.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Expr2 github.com/xawk/vitess/go/vt/sqlparser.Expr
...
func (cached *Union) CachedSize(alloc bool) int64 {
	...
	// field FirstStatement github.com/xawk/vitess/go/vt/sqlparser.SelectStatement
	if cc, ok := cached.FirstStatement.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field UnionSelects []*github.com/xawk/vitess/go/vt/sqlparser.UnionSelect
	{
...
func (cached *UnionSelect) CachedSize(alloc bool) int64 {
	...
	// field Statement github.com/xawk/vitess/go/vt/sqlparser.SelectStatement
...
func (cached *VindexParam) CachedSize(alloc bool) int64 {
	...
	// field Key github.com/xawk/vitess/go/vt/sqlparser.ColIdent
...
func (cached *VindexSpec) CachedSize(alloc bool) int64 {
	...
	// field Name github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	size += cached.Name.CachedSize(false)
	// field Type github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	size += cached.Type.CachedSize(false)
	// field Params []github.com/xawk/vitess/go/vt/sqlparser.VindexParam
	{
...
func (cached *When) CachedSize(alloc bool) int64 {
	...
	// field Cond github.com/xawk/vitess/go/vt/sqlparser.Expr
	if cc, ok := cached.Cond.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Val github.com/xawk/vitess/go/vt/sqlparser.Expr
