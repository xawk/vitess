...
func (cached *BinaryOp) CachedSize(alloc bool) int64 {
	...
	// field Expr github.com/xawk/vitess/go/vt/vtgate/evalengine.BinaryExpr
	if cc, ok := cached.Expr.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Left github.com/xawk/vitess/go/vt/vtgate/evalengine.Expr
	if cc, ok := cached.Left.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Right github.com/xawk/vitess/go/vt/vtgate/evalengine.Expr
...
func (cached *Literal) CachedSize(alloc bool) int64 {
	...
	// field Val github.com/xawk/vitess/go/vt/vtgate/evalengine.EvalResult
