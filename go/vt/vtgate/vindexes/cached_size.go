...
func (cached *AutoIncrement) CachedSize(alloc bool) int64 {
	...
	// field Sequence *github.com/xawk/vitess/go/vt/vtgate/vindexes.Table
...
func (cached *ColumnVindex) CachedSize(alloc bool) int64 {
	...
	// field Columns []github.com/xawk/vitess/go/vt/sqlparser.ColIdent
	{
	...
	// field Name string
	size += int64(len(cached.Name))
	// field Vindex github.com/xawk/vitess/go/vt/vtgate/vindexes.Vindex
...
func (cached *ConsistentLookup) CachedSize(alloc bool) int64 {
	...
	// field clCommon *github.com/xawk/vitess/go/vt/vtgate/vindexes.clCommon
...
func (cached *LookupHash) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += int64(len(cached.name))
	// field lkp github.com/xawk/vitess/go/vt/vtgate/vindexes.lookupInternal
...
func (cached *NumericStaticMap) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += int64(len(cached.name))
	// field lookup github.com/xawk/vitess/go/vt/vtgate/vindexes.NumericLookupTable
...
func (cached *RegionJSON) CachedSize(alloc bool) int64 {
	...
	// field name string
	size += int64(len(cached.name))
	// field regionMap github.com/xawk/vitess/go/vt/vtgate/vindexes.RegionMap
...
func (cached *Table) CachedSize(alloc bool) int64 {
	...
	// field ColumnVindexes []*github.com/xawk/vitess/go/vt/vtgate/vindexes.ColumnVindex
	{
	...
	// field Ordered []*github.com/xawk/vitess/go/vt/vtgate/vindexes.ColumnVindex
	{
	...
	// field Owned []*github.com/xawk/vitess/go/vt/vtgate/vindexes.ColumnVindex
	{
	...
	// field AutoIncrement *github.com/xawk/vitess/go/vt/vtgate/vindexes.AutoIncrement
	size += cached.AutoIncrement.CachedSize(true)
	// field Columns []github.com/xawk/vitess/go/vt/vtgate/vindexes.Column
	{
