...
func (cached *AlterVSchema) CachedSize(alloc bool) int64 {
	...
	// field Keyspace *github.com/xawk/vitess/go/vt/vtgate/vindexes.Keyspace
	size += cached.Keyspace.CachedSize(true)
	// field AlterVschemaDDL *github.com/xawk/vitess/go/vt/sqlparser.AlterVschema
...
func (cached *Concatenate) CachedSize(alloc bool) int64 {
	...
	// field Sources []github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
	{
...
func (cached *DDL) CachedSize(alloc bool) int64 {
	...
	// field DDL github.com/xawk/vitess/go/vt/sqlparser.DDLStatement
	if cc, ok := cached.DDL.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field NormalDDL *github.com/xawk/vitess/go/vt/vtgate/engine.Send
	size += cached.NormalDDL.CachedSize(true)
	// field OnlineDDL *github.com/xawk/vitess/go/vt/vtgate/engine.OnlineDDL
...
func (cached *DML) CachedSize(alloc bool) int64 {
	...
	// field Keyspace *github.com/xawk/vitess/go/vt/vtgate/vindexes.Keyspace
	size += cached.Keyspace.CachedSize(true)
	// field TargetDestination github.com/xawk/vitess/go/vt/key.Destination
	if cc, ok := cached.TargetDestination.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Query string
	size += int64(len(cached.Query))
	// field Vindex github.com/xawk/vitess/go/vt/vtgate/vindexes.SingleColumn
	if cc, ok := cached.Vindex.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Values []github.com/xawk/vitess/go/sqltypes.PlanValue
	{
	...
	// field KsidVindex github.com/xawk/vitess/go/vt/vtgate/vindexes.SingleColumn
	if cc, ok := cached.KsidVindex.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Table *github.com/xawk/vitess/go/vt/vtgate/vindexes.Table
...
func (cached *Delete) CachedSize(alloc bool) int64 {
	...
	// field DML github.com/xawk/vitess/go/vt/vtgate/engine.DML
...
func (cached *Distinct) CachedSize(alloc bool) int64 {
	...
	// field Source github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
...
func (cached *Insert) CachedSize(alloc bool) int64 {
	...
	// field Query string
	size += int64(len(cached.Query))
	// field VindexValues []github.com/xawk/vitess/go/sqltypes.PlanValue
	{
	...
	// field Table *github.com/xawk/vitess/go/vt/vtgate/vindexes.Table
	size += cached.Table.CachedSize(true)
	// field Generate *github.com/xawk/vitess/go/vt/vtgate/engine.Generate
...
func (cached *Join) CachedSize(alloc bool) int64 {
	...
	// field Left github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
	if cc, ok := cached.Left.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Right github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
...
func (cached *Limit) CachedSize(alloc bool) int64 {
	...
	// field Count github.com/xawk/vitess/go/sqltypes.PlanValue
	size += cached.Count.CachedSize(false)
	// field Offset github.com/xawk/vitess/go/sqltypes.PlanValue
	size += cached.Offset.CachedSize(false)
	// field Input github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
...
func (cached *MemorySort) CachedSize(alloc bool) int64 {
	...
	// field UpperLimit github.com/xawk/vitess/go/sqltypes.PlanValue
	size += cached.UpperLimit.CachedSize(false)
	// field OrderBy []github.com/xawk/vitess/go/vt/vtgate/engine.OrderbyParams
	{
...
func (cached *MergeSort) CachedSize(alloc bool) int64 {
	...
	// field Primitives []github.com/xawk/vitess/go/vt/vtgate/engine.StreamExecutor
	{
...
func (cached *OnlineDDL) CachedSize(alloc bool) int64 {
	...
	// field SQL string
	size += int64(len(cached.SQL))
	// field Strategy github.com/xawk/vitess/go/vt/schema.DDLStrategy
...
func (cached *OrderedAggregate) CachedSize(alloc bool) int64 {
	...
	// field Aggregates []github.com/xawk/vitess/go/vt/vtgate/engine.AggregateParams
	{
...
func (cached *Plan) CachedSize(alloc bool) int64 {
	...
	// field Instructions github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
	if cc, ok := cached.Instructions.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field BindVarNeeds *github.com/xawk/vitess/go/vt/sqlparser.BindVarNeeds
...
func (cached *Projection) CachedSize(alloc bool) int64 {
	...
	// field Exprs []github.com/xawk/vitess/go/vt/vtgate/evalengine.Expr
	{
...
func (cached *PulloutSubquery) CachedSize(alloc bool) int64 {
	...
	// field Subquery github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
	if cc, ok := cached.Subquery.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field Underlying github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
...
func (cached *Route) CachedSize(alloc bool) int64 {
	...
	// field SysTableTableSchema github.com/xawk/vitess/go/vt/vtgate/evalengine.Expr
	if cc, ok := cached.SysTableTableSchema.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field SysTableTableName github.com/xawk/vitess/go/vt/vtgate/evalengine.Expr
...
func (cached *Rows) CachedSize(alloc bool) int64 {
	...
	// field rows [][]github.com/xawk/vitess/go/sqltypes.Value
	{
	...
	// field fields []*github.com/xawk/vitess/go/vt/proto/query.Field
	{
...
func (cached *SQLCalcFoundRows) CachedSize(alloc bool) int64 {
	...
	// field LimitPrimitive github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
	if cc, ok := cached.LimitPrimitive.(cachedObject); ok {
		size += cc.CachedSize(true)
	}
	// field CountPrimitive github.com/xawk/vitess/go/vt/vtgate/engine.Primitive
...
func (cached *Set) CachedSize(alloc bool) int64 {
	...
	// field Ops []github.com/xawk/vitess/go/vt/vtgate/engine.SetOp
	{
...
func (cached *SysVarSetAware) CachedSize(alloc bool) int64 {
	...
	// field Name string
	size += int64(len(cached.Name))
	// field Expr github.com/xawk/vitess/go/vt/vtgate/evalengine.Expr
...
func (cached *Update) CachedSize(alloc bool) int64 {
	...
	// field DML github.com/xawk/vitess/go/vt/vtgate/engine.DML
	size += cached.DML.CachedSize(false)
	// field ChangedVindexValues map[string]*github.com/xawk/vitess/go/vt/vtgate/engine.VindexValues
...
func (cached *VindexFunc) CachedSize(alloc bool) int64 {
	...
	// field Value github.com/xawk/vitess/go/sqltypes.PlanValue
...
func (cached *VindexValues) CachedSize(alloc bool) int64 {
	...
	// field PvMap map[string]github.com/xawk/vitess/go/sqltypes.PlanValue
	if cached.PvMap != nil {
		size += int64(48)
...
func (cached *shardRoute) CachedSize(alloc bool) int64 {
	...
	// field query string
	size += int64(len(cached.query))
	// field rs *github.com/xawk/vitess/go/vt/srvtopo.ResolvedShard
	size += cached.rs.CachedSize(true)
	// field bv map[string]*github.com/xawk/vitess/go/vt/proto/query.BindVariable
	if cached.bv != nil {
		size += int64(48)
