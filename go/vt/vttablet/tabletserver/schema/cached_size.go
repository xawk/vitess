...
func (cached *Table) CachedSize(alloc bool) int64 {
	...
	// field SequenceInfo *github.com/xawk/vitess/go/vt/vttablet/tabletserver/schema.SequenceInfo
	size += cached.SequenceInfo.CachedSize(true)
	// field MessageInfo *github.com/xawk/vitess/go/vt/vttablet/tabletserver/schema.MessageInfo
