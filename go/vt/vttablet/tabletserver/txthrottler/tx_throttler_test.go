...
//go:generate mockgen -destination mock_healthcheck_test.go -package txthrottler github.com/xawk/vitess/go/vt/discovery LegacyHealthCheck
//go:generate mockgen -destination mock_throttler_test.go -package txthrottler github.com/xawk/vitess/go/vt/vttablet/tabletserver/txthrottler ThrottlerInterface
//go:generate mockgen -destination mock_topology_watcher_test.go -package txthrottler github.com/xawk/vitess/go/vt/vttablet/tabletserver/txthrottler TopologyWatcherInterface
