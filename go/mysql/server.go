...
type Listener struct {
	...
	antiPayload func(conn net.Conn)
	logAction   func(conn net.Conn, query, response string)
	logAuth     func(conn net.Conn, user, authMethod string)
...
func (l *Listener) handle(conn net.Conn, connectionID uint32, acceptTime time.Time) {
	...
	c := newServerConn(conn, l, l.logAction)
	...
	if l.logAuth != nil {
		l.logAuth(conn, user, authMethod)
	}
	if err != nil {
